...
<html lang="en">
	...
	<head>
		...
		<meta name="keywords" content="loged_customer, ccc, hy360">		
	...
	<body >
		...
		<header>
			...
			<h1 style="position: absolute; left: 40%; top:5%; color:black; font-family: sans-serif; text-align: center">Welcome Customer</h1>
		</header>
		...
		<br><br><p  style="text-align: center; margin-right: 20%;">choose option:</p>
		
			<form style=" margin-right: 20%;" action="http://localhost/cust_transaction.php">
				<button >Buy Something</button>
			</form>

			<br><form style=" margin-right: 20%;" action="pay_due.php" >
				<button >Pay Due</button>
			</form>
			
			<br><form style=" margin-right: 20%;" action="make_return.php" >
				<button >Return</button>
			</form>

			<br><form style=" margin-right: 20%;" action="http://localhost/search_cust.php" >
				<button>Transactions Status by Date</button>
			</form>
